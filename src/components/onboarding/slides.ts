    ...
    steps: [
      {
        ...
        body: 'Tell us what you want to improve and what matters.',
      },
      {
        index: '02',
        title: 'Your Personalized Plan',
        body: 'We craft a care plan with the right treatments.',
      },
      {
        index: '03',
        title: 'Track Your Progress',
        body: 'Stay on track with appointments and milestones.',
      },
    ],
  },
  {
